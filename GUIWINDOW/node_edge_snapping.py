# -*- coding: utf-8 -*-
"""
A module containing the Edge Snapping functions which are used in :class:`~GUIWINDOW.node_graphics_view.QDMGraphicsView` class.
"""
...
class EdgeSnapping():
    ...
    def getSnappedSocketItem(self, event: 'QMouseEvent') -> 'QDMGraphicsSocket':
        """Returns :class:`~GUIWINDOW.node_graphics_socket.QDMGraphicsSocket` which we should snap to"""
